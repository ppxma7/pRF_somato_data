...
% %
% theGRANDpca_basetips = load('prf_1d_nodiag2_novBASETIPS_myPCA.mat');
% theGRANDpca = load('prf_1d_nodiag2_novBAA_myPCA.mat');
% %
% theGRANDpca_basetips = load('prf_1dt_nodiag2_novBASETIPS_myPCA.mat');
% theGRANDpca = load('prf_1dt_nodiag2_novBAA_myPCA.mat');

% theGRANDpca_basetips = load('prf_sixteen_nodiag2_com_novBASETIPS_myPCA.mat');
% theGRANDpca = load('prf_sixteen_nodiag2_com_novBAA_myPCA.mat');

theGRANDpca_basetips = load('prf_2ddouble_dd_novBASETIPS_myPCA.mat');
...
for iBa = 1:4
    ...
    for iDig = 1:4
        ...
        s_= scatter(x0,y0,'filled','markerfacecolor', 'w', ...
            'markeredgecolor', 'k');
        t_ = text(-2,-2,sprintf('dig:%d, %s, model:%s', myDig, ...
            myBa, currentModel));
        set(t_, 'color', [0 0 0 ], ...
...
if orthogMe ~= 1
    thisBA3b = cell2mat(thisgrid(2,:)); %D2
else
    thisBA3b = cell2mat(thisgrid(:,2)); %D2
end
...
if orthogMe ~= 1
    thisBA1 = cell2mat(thisgrid(3,:)); %D2
else
    thisBA1 = cell2mat(thisgrid(:,3)); %D2
end
...
if orthogMe ~= 1
    thisBA2 = cell2mat(thisgrid(4,:)); %D2
else
    thisBA2 = cell2mat(thisgrid(:,4)); %D2
end
...
s_= scatter(x0,y0,'filled','markerfacecolor', 'w', ...
    'markeredgecolor', 'k');
if orthogMe ~= 1; t_ = text(10,-1,'BA3a');else t_ = text(10,-1,'D2'); end
...
s_= scatter(x0,y0,'filled','markerfacecolor', 'w', ...
    'markeredgecolor', 'k');
if orthogMe ~= 1; t_ = text(10,-1,'BA3b');else t_ = text(10,-1,'D3'); end
set(t_, 'color', [0 0 0 ],'fontsize', 16, 'fontname', 'helvetica', 'interpreter', 'none','verticalalignment', 'top');
ax = gca;
ax.FontSize = 12;
colorbar
...
s_= scatter(x0,y0,'filled','markerfacecolor', 'w', ...
    'markeredgecolor', 'k');
if orthogMe ~= 1; t_ = text(10,-1,'BA1');else t_ = text(10,-1,'D4'); end
set(t_, 'color', [0 0 0 ],'fontsize', 16, 'fontname', 'helvetica', 'interpreter', 'none','verticalalignment', 'top');
ax = gca;
ax.FontSize = 12;
colorbar
...
s_= scatter(x0,y0,'filled','markerfacecolor', 'w', ...
    'markeredgecolor', 'k');
if orthogMe ~= 1; t_ = text(10,-1,'BA2');else t_ = text(10,-1,'D5'); end
...
if orthogMe ~= 1
print(gcf, sprintf('grandmeanofPCA_summed_weighted_%s_PC%s_BAA_interped',currentModel, num2str(noComponents)), '-r300', '-dpng')
else
    print(gcf, sprintf('ORTHOGgrandmeanofPCA_summed_weighted_%s_PC%s_BAA_interped',currentModel, num2str(noComponents)), '-r300', '-dpng')
end
...
title('BA2')
print(gcf, sprintf('alignedaverage_%s_PC%s_BAA_interped',currentModel, num2str(noComponents)), '-r300', '-dpng')
...
%     nexttile
%     A = thisBA3a_cat(:,:,ii);
%     %B(:,:,ii) = A-repmat(mean(A,3),size(A,3),1);
%     B(:,:,ii) = A-mean(A,3);
%
%     [xb(ii), yb(ii)] = find2dMax(B(:,:,ii));
%     imagesc(B(:,:,ii))
%     colormap jet
%     hold on
%     scatter(xb(ii),yb(ii),'filled','markerfacecolor', 'w', ...
%     'markeredgecolor', 'k');
% end
...
s_= scatter(x0,y0,'filled','markerfacecolor', 'w', ...
    'markeredgecolor', 'k');
%t_ = text(10,-1,'PD1');
if orthogMe ~= 1; t_ = text(10,-1,'PD1');else t_ = text(10,-1,'D2'); end
set(t_, 'color', [0 0 0 ],'fontsize', 16, 'fontname', 'helvetica', 'interpreter', 'none','verticalalignment', 'top');
ax = gca;
ax.FontSize = 12;
colorbar
...
s_= scatter(x0,y0,'filled','markerfacecolor', 'w', ...
    'markeredgecolor', 'k');
%t_ = text(10,-1,'PD2');
if orthogMe ~= 1; t_ = text(10,-1,'PD2');else t_ = text(10,-1,'D3'); end
set(t_, 'color', [0 0 0 ],'fontsize', 16, 'fontname', 'helvetica', 'interpreter', 'none','verticalalignment', 'top');
ax = gca;
ax.FontSize = 12;
colorbar
...
s_= scatter(x0,y0,'filled','markerfacecolor', 'w', ...
    'markeredgecolor', 'k');
%t_ = text(10,-1,'PD3');
if orthogMe ~= 1; t_ = text(10,-1,'PD3');else t_ = text(10,-1,'D4'); end
set(t_, 'color', [0 0 0 ],'fontsize', 16, 'fontname', 'helvetica', 'interpreter', 'none','verticalalignment', 'top');
ax = gca;
ax.FontSize = 12;
colorbar
...
s_= scatter(x0,y0,'filled','markerfacecolor', 'w', ...
    'markeredgecolor', 'k');
%t_ = text(10,-1,'PD4');
if orthogMe ~= 1; t_ = text(10,-1,'PD4');else t_ = text(10,-1,'D5'); end
set(t_, 'color', [0 0 0 ],'fontsize', 16, 'fontname', ...
    'helvetica', 'interpreter', 'none','verticalalignment','top');
ax = gca;
ax.FontSize = 12;
...
print(gcf, sprintf('grandmeanofPCA_summed_weighted_%s_PC%s_BASETIPS_interped',currentModel, num2str(noComponents)), '-r300', '-dpng')
    ...
    print(gcf, sprintf('ORTHOGgrandmeanofPCA_summed_weighted_%s_PC%s_BASETIPS_interped',currentModel, num2str(noComponents)), '-r300', '-dpng')
end
...
imagesc(ax4,bigmean2)
title('PD4')
print(gcf, sprintf('alignedaverage_%s_PC%s_BASETIPS_interped',currentModel, num2str(noComponents)), '-r300', '-dpng')
